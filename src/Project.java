...
public class Project {
	 ...
	 * The string varies depending on the projects completion state.
	 * 
	 * @return string representation of the file.
	 */
	public String fileFormat() {
		if(finalised) {
			return projName + ", " + projNum + ", " + address
					+ ", " + erf + ", " + buildType + ", " 
					+ fee + ", " + paidAmount + ", " + Checks.stringDate(deadline) 
					+ ", " + genCompState() + ", " + Checks.stringDate(dateCompleted)  
					+ ", " + customer.getName()
					+ ", " + contractor.getName() + ", " + architect.getName();
		}else {
			return projName + ", " + projNum + ", " + address
					+ ", " + erf + ", " + buildType + ", " 
					+ fee + ", " + paidAmount + ", " + Checks.stringDate(deadline) 
					+ ", " + genCompState() + ", " + customer.getName()
					+ ", " + contractor.getName() + ", " + architect.getName();
		}
	}
